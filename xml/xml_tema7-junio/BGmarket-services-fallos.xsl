              ...
              <xsl:element name="tr">
               ...
               <td>
                ...
                <td>
                  ...
                  <!-- con esto da fallo, puesto que lo aplicaba siempre.
                  <details>
                  ...
                  <xsl:choose>
                    <xsl:when test="not(descripcionproducto/detalles/p)">
                    </xsl:when>
                    <xsl:otherwise>
                     <details>
                        <xsl:for-each select="descripcionproducto/detalles/p">
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="ends-with(@id, 2) or ends-with(@id, 8)">
                        <xsl:if test="count(precio) = 2">
                           <p style="color:green;"><xsl:value-of select="precio"/> &#160; <xsl:value-of select="precio/@moneda"/>(s) </p>
                           <p style="color:green;"><xsl:value-of select="precio[last()]"/> &#160; <xsl:value-of select="precio/@moneda"/>(s) </p>
                        </xsl:if>
